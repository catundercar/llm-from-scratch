#!/usr/bin/env python3
"""
Phase 4 · Auto-Grading Script
===============================

Runs all Phase 4 test suites and prints a visual progress report.
...
LABS = [
    ("Lab 1: Training Utilities", "tests/test_lab1_utils.py"),
    ("Lab 2: Training Loop", "tests/test_lab2_train.py"),
]
...
def run_tests(test_path: str) -> tuple[int, int]:
    ...
    # Matches patterns like "5 passed", "3 failed", "2 passed, 1 failed"
    passed = 0
    failed = 0
    errors = 0
    ...
    if total == 0:
        # Try to count test items collected
...
def main():
    ...
    print()
    print("\u2550" * 50)
    print("  Phase 4 \u00b7 Pretraining \u00b7 Grading Report")
    print("\u2550" * 50)
    print()
