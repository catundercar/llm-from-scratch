...
import { getPhase0Content } from "./lessons_p0";
// Phases 1-9: still zh-TW only, will be converted by agents
import { getPhase1Content, getPhase2Content } from "./lessons_p1_p2";
import { getPhase3Content, getPhase4Content } from "./lessons_p3_p4";
import { getPhase5Content, getPhase6Content } from "./lessons_p5_p6";
import { getPhase7Content, getPhase8Content, getPhase9Content } from "./lessons_p7_p8_p9";
